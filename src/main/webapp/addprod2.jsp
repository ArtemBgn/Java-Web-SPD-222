    ...
    <form class="col s12" method="post">
        <div class="row">
            <div class="input-field col s6">
                <input type="text" id="product_name" name="product_name" placeholder="Введіть назву продукту" aria-label="Назва продукту" class="validate">
                <label for="product_name">Назва продукту</label>
            </div>
            <div class="input-field col s6">
                <input type="number" id="product_price" name="product_price" placeholder="Введіть вартість продукту" aria-label="Вартість продукту" class="validate">
                <label for="product_price">Вартість продукту</label>
            </div>
        </div>
        <div class="row">
            <div class="input-field col s12">
                <input type="text" id="product_description" name="product_description" placeholder="Опишіть продукт" aria-label="Опишіть продукт" class="validate">
